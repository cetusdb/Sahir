...
const themes: Item[] = [
  { id: 'default',   label: 'Varsayılan', emoji: '🎬', desc: 'Standart koyu tema'    },
  { id: 'christmas', label: 'Christmas',  emoji: '🎄', desc: 'Kar, kırmızı, altın'   },
  { id: 'halloween', label: 'Halloween',  emoji: '🎃', desc: 'Turuncu, mor, ürpertici' }
];
